...
const SuperAdminSidebar = ({ open, setOpen }) => {
  ...
  const content = [
    ...
    },
    {
      ...
      route: SUPER_ADMIN_ROUTES.partnerManagement,
      icon: TbUsersGroup,
    },
    {
    ...
    {
      name: 'Inventory',
      route: SUPER_ADMIN_ROUTES.inventory,
      icon: TbShoppingCart,
    },
    {
      name: 'Transactions',
    ...
    {
      name: 'Analytics',
      route: SUPER_ADMIN_ROUTES.analytics,
      icon: TbBrandGoogleAnalytics,
    },
    {
      name: 'Settings',
      route: SUPER_ADMIN_ROUTES.settings,
      icon: TbSettings,
    },
  ];
        ...
        <div className="justify-start">
          <div className=" ">
            <div className="px-[18px] py-5 h-16 mb-8 flex justify-between items-center">
              <Link to={SUPER_ADMIN_ROUTES.dashboard}>
                <img
